 ...
 */
public class JpanelIlerna_4 extends JPanel {
	/**
	...
	public JpanelIlerna_4() {

		setLayout(null);

		JLabel lblNewLabel = new JLabel("<html>¿Cuantas veces pedimos bajar a por garrín al día?</html>");
		
		lblNewLabel.setForeground(new Color(0, 0, 0));
		lblNewLabel.setFont(new Font("Palatino Linotype", Font.PLAIN, 50));
		lblNewLabel.setBounds(680, 159, 590, 161);
